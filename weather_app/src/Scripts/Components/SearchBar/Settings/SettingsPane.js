...
import {CelsiusToFahrenheit, KelvinToCelsius, FahrenheitToCelsius } from '../../WeatherPane/KelvinToCelsius.js'
        ...
        return(
            <div className={Styles.HideBackPanel}>
                <div className={Styles.SettingsPane}>
                    ...
                    <p><input type="radio" name="TempType" readOnly onClick={this.switchCelsius}></input> Celsius </p>
